...
;(function($,window,document,undefined){
	...
	function Poplayer(element,parameter){
		this.element = element;
		this.options = $.extend({},defaults,parameter);
		this.init();
	}
	...
	Poplayer.prototype = {
		...
		open:function(func){
			if(this.options.beforeShow(this) != false){
				(func || function(){})();
				console.log('open');
			}
		},
	...
	$.fn.poplayer = function(parameter,callback){
		...
		return this.each(function(){
			var poplayer = new Poplayer(this,parameter);
			callback(poplayer);
		});
	};
