<template>
  <div class="mod-pagination">
    <div class="content">
      ...
      <div class="bd">
        <div class="eg">
          <div class="pagination M-box"></div>
          <p class="tips">当前是第
        ...
        <div class="eg">
          <div class="pagination M-box2"></div>
        ...
        <div class="eg">
          <div class="pagination M-box1"></div>
          <p class="tips">
            总数据
        ...
        <div class="eg">
          <div class="pagination M-box3"></div>
        ...
        <div class="eg">
          <div class="pagination M-box4"></div>
